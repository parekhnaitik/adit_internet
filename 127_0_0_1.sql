...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 19, 2017 at 03:04 PM
...
INSERT INTO `admin_user` (`pk`, `username`, `password`, `firstName`, `lastName`, `contactNumber`) VALUES
(1, 'admin', 'a', 'Admin', 'User', '123');
...
(4, '140010116010', 'Naitik', 'Parekh', '14', 'pn13@gmail.com', '1234567890', 'IT', 'Student'),
(6, '140010116021', 'akash', 'patel', '140010116021', 'a@gmail.com', '23', 'Information Technology', 'Student'),
(7, '140010116047', 'Hardip', 'Raj', '140010116047', 'rajhardip96@gmail.com', '9913592869', 'Information Technology', 'Student');
...
--
ALTER TABLE `admin_user`
  MODIFY `pk` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `internet_user`
--
ALTER TABLE `internet_user`
  MODIFY `pk` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
